...
for i=1:5
    [Call_est(:,i),diff_call(:,i),volatility_c(:,i)] = BLS_callprice_func(FTSE100,Calls(:,i),index(i));
    [Put_est(:,i),diff_put(:,i),volatility_p(:,i)] = BLS_putprice_func(FTSE100,Puts(:,i),index(i));
    figure(i);
    subplot(2,1,1);
